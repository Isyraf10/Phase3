...
public class TestClass {
    public static void main(String[] args) {
        ...
        Mechanic mechanic = new Mechanic("M001", "Smokey Nagata", "017-654-3210");
        Supplier supplier = new Supplier("S001", "AutoParts Inc.", "06-458-4536");
        InventoryItem item1 = new InventoryItem("I001", "Brake Pad", 150.0, 2);
        InventoryItem item2 = new InventoryItem("I002", "Oil Filter", 30.0, 1);
        List<InventoryItem> inventoryList = new ArrayList<>();
        inventoryList.add(item1);
        inventoryList.add(item2);

        Repair repair = new Repair("R001", "2025-04-30", "10:30 AM");
        Report report = new Report("REP001",180.0, 3);

        Booking booking = new Booking("B001", "2025-04-30", "10:00 AM", "Confirmed");
